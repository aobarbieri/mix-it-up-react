...
const Recipes = () => (
	<article>
		<div className='bg-white w-full px-5'>
			<button className='font-medium lg:font-normal my-5 lg:border lg:px-3 lg:py-2'>
			...
			<header>
				...
				<section>
					...
					<p className='md:text-lg'>
						...
						complements both ingredients while taming some of the sweetness. It also doesn’t hurt that the
						Cuba Libre contains caffeine and sugar, making it a preferred party drink, whether you’re
						celebrating your independence at a dive bar or a dance club.
					</p>
				</section>
			</header>
